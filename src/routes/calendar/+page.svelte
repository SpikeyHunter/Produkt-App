<script lang="ts">
	...
	import CalendarPreferences from '$lib/components/calendar/CalendarPreferences.svelte';
...
{:else if authState === 'authenticated'}
	...
	>
		<div class="text-white text-2xl font-bold mb-6">
			Contact List - (<span class="text-lime">{userCount} users</span>)
		</div>

		<CalendarContactList on:countUpdate={(e) => (userCount = e.detail)} />
	</Modal>

	<CalendarSettings bind:isOpen={showSettingsModal} />
{/if}
<CalendarPreferences bind:isOpen={showPreferencesModal} />
