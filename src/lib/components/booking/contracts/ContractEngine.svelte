<script lang="ts">
	...
	function openAppWithFallback(advanceId: any) {
		...
		const downloadUrl =
			'https://vngekjtqbdnfeombtjnx.supabase.co/storage/v1/object/public/app-updates/ProduktRed_1.1.0.dmg';
				...
				<div class="text-center space-y-6 max-w-sm">
					...
					<div class="flex flex-col gap-3 pt-2">
						...
						<div class="text-xs text-gray3 mt-4">
							Don't have the app?
							<a
								href="https://vngekjtqbdnfeombtjnx.supabase.co/storage/v1/object/public/app-updates/ProduktRed_1.1.0.dmg"
