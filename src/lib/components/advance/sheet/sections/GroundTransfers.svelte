          ...
          <div class="space-y-1 text-sm">
            {#each uniqueDrivers as driver}
              <div class="text-gray2">
                <span class="font-bold text-white">Driver:</span> {driver.name} - {driver.phone}
              </div>
            {/each}
            <div class="text-gray2">
              <span class="font-bold text-white">Vehicle:</span> {advanceSettings.vehicle}
            </div>
            {#if hasUber}
              <div class="text-gray2 pt-2">
                <span class="font-bold text-white">UBER:</span> {advanceSettings.drivers['UBER']}
              </div>
            {/if}
          </div>
        </div>
              ...
              <table class="w-full text-xs">
                <thead>
                  <tr class="border-b border-gray2/20 whitespace-nowrap">
                    ...
                    <th class="py-2 pl-2 text-gray2 uppercase tracking-wider text-left w-[19%]">Notes</th>
                  </tr>
                </thead>
