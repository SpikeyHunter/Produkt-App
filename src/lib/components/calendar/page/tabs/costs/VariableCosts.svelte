...
<section class="flex flex-col mt-6">
    <div 
        class="flex flex-wrap items-center justify-between gap-4 cursor-pointer select-none px-4 py-3 rounded-t-xl transition-colors view-only-exception {expanded ? 'bg-gray1/80' : 'hover:bg-gray1'}"
        role="button"
        tabindex="0"
