...
<svelte:window on:click={(e) => {
	if (showStatusDrop && !e.target.closest('.status-dropdown-container')) showStatusDrop = false;
}}/>
...
<div class="bg-gray1 flex flex-col shrink-0 relative z-20 border-b border-gray2/10">
	...
	<div class="px-6 py-4 flex justify-between items-center border-b border-gray2/10">
		<div class="group relative flex items-center">
			...
			{:else}
				<h1 
					class="text-2xl font-black text-white cursor-pointer hover:text-lime transition-colors px-1" 
	...
	<div class="px-6 py-3 flex items-center gap-3 border-b border-gray2/10">
		...
		<button class="flex items-center gap-1.5 px-3 py-1.5 bg-navbar border border-gray2/20 rounded-full text-gray2 hover:bg-white/5 hover:text-white transition-colors cursor-pointer">
