...
function _page($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    head($$payload2, ($$payload3) => {
      $$payload3.title = `<title>Forgot Password – Produkt App</title>`;
    });
    ...
    Button($$payload2, {
      ...
      children: ($$payload3) => {
        $$payload3.out.push(`<!---->${escape_html("Reset Password")}`);
      },
      $$slots: { default: true }
    });
