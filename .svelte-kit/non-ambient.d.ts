...
declare module "$app/types" {
	export interface AppTypes {
		...
		Pathname(): "/" | "/advancing" | "/advancing/" | "/advancing/artistliaison" | "/advancing/artistliaison/" | "/advancing/gathered" | "/advancing/gathered/" | `/advancing/gathered/${string}` & {} | `/advancing/gathered/${string}/` & {} | "/advancing/hoteltracker" | "/advancing/hoteltracker/" | "/advancing/localartists" | "/advancing/localartists/" | "/advancing/merchsettlement" | "/advancing/merchsettlement/" | "/api" | "/api/" | "/api/apple" | "/api/apple/" | "/api/booking" | "/api/booking/" | "/api/booking/evenko" | "/api/booking/evenko/" | "/api/booking/evenko/cancel" | "/api/booking/evenko/cancel/" | "/api/booking/igloofest" | "/api/booking/igloofest/" | "/api/booking/igloofest/cancel" | "/api/booking/igloofest/cancel/" | "/api/booking/piknic" | "/api/booking/piknic/" | "/api/booking/piknic/cancel" | "/api/booking/piknic/cancel/" | "/api/bug-report" | "/api/bug-report/" | "/api/calendar-confirm-email" | "/api/calendar-confirm-email/" | "/api/calendar-confirm-sms" | "/api/calendar-confirm-sms/" | "/api/calendar-invite-mail" | "/api/calendar-invite-mail/" | "/api/calendar-invite-phone" | "/api/calendar-invite-phone/" | "/api/calendar-modify-email" | "/api/calendar-modify-email/" | "/api/calendar-modify-sms" | "/api/calendar-modify-sms/" | "/api/calendar" | "/api/calendar/" | "/api/deezer" | "/api/deezer/" | "/api/deezer/search" | "/api/deezer/search/" | "/api/download-tech-rider" | "/api/download-tech-rider/" | "/api/flight-lookup" | "/api/flight-lookup/" | "/api/generate-advance-pdf" | "/api/generate-advance-pdf/" | "/api/generate-liaison-pdf" | "/api/generate-liaison-pdf/" | "/api/generate-merch-pdf" | "/api/generate-merch-pdf/" | "/api/generate-settimes-pdf" | "/api/generate-settimes-pdf/" | "/api/google-calendar" | "/api/google-calendar/" | "/api/guests" | "/api/guests/" | "/api/latest-commit" | "/api/latest-commit/" | "/api/passport-ocr" | "/api/passport-ocr/" | "/api/register" | "/api/register/" | "/api/sync-drive-rider" | "/api/sync-drive-rider/" | "/api/update-event" | "/api/update-event/" | "/api/upload" | "/api/upload/" | "/api/validate-registration-code" | "/api/validate-registration-code/" | "/api/validate-team-code" | "/api/validate-team-code/" | "/api/webhooks" | "/api/webhooks/" | "/api/webhooks/sns-inbound" | "/api/webhooks/sns-inbound/" | "/auth" | "/auth/" | "/auth/callback" | "/auth/callback/" | "/auth/forgot-password" | "/auth/forgot-password/" | "/auth/reset-password" | "/auth/reset-password/" | "/auth/verify" | "/auth/verify/" | "/booking" | "/booking/" | "/booking/artistavailability" | "/booking/artistavailability/" | "/booking/talentpayments" | "/booking/talentpayments/" | "/calendar" | "/calendar/" | "/calendar/unsubscribe" | "/calendar/unsubscribe/" | `/calendar/${string}` & {} | `/calendar/${string}/` & {} | `/calendar/${string}${string}` & {} | `/calendar/${string}${string}/` & {} | "/contact-card" | "/contact-card/" | "/dashboard" | "/dashboard/" | "/letter" | "/letter/" | "/login" | "/login/" | "/login/forgot-password" | "/login/forgot-password/" | "/login/register" | "/login/register/" | "/login/reset-confirmed" | "/login/reset-confirmed/" | "/login/reset-password" | "/login/reset-password/" | "/marketing" | "/marketing/" | "/marketing/comparehub" | "/marketing/comparehub/" | "/marketing/comptickets" | "/marketing/comptickets/" | "/marketing/customers" | "/marketing/customers/" | "/marketing/eventsinfo" | "/marketing/eventsinfo/" | "/ncgapp" | "/ncgapp/" | "/ncgapp/controlcenter" | "/ncgapp/controlcenter/" | "/production" | "/production/" | "/production/backline" | "/production/backline/" | "/production/emailtech" | "/production/emailtech/" | "/production/showbudget" | "/production/showbudget/" | "/production/techrider" | "/production/techrider/" | "/public" | "/public/" | "/public/invoice" | "/public/invoice/" | `/public/invoice/${string}` & {} | `/public/invoice/${string}/` & {} | "/schedules" | "/schedules/" | "/schedules/stagemanager" | "/schedules/stagemanager/" | "/schedules/tech" | "/schedules/tech/" | "/settimes" | "/settimes/" | "/settings" | "/settings/" | "/sultanshepard" | "/sultanshepard/" | "/sultanshepard/djshow" | "/sultanshepard/djshow/" | `/sultanshepard/djshow/${string}` & {} | `/sultanshepard/djshow/${string}/` & {} | "/wifi" | "/wifi/" | "/wifi/corpo" | "/wifi/corpo/" | "/wifi/ncg" | "/wifi/ncg/";
