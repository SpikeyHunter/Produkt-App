...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/advancing" | "/advancing/gathered" | "/advancing/gathered/[event_param]" | "/api" | "/api/flight-lookup" | "/api/generate-advance-pdf" | "/api/google-calendar" | "/api/guests" | "/api/latest-commit" | "/api/passport-ocr" | "/api/register" | "/api/update-event" | "/api/upload" | "/api/validate-registration-code" | "/api/validate-team-code" | "/auth" | "/auth/callback" | "/auth/forgot-password" | "/auth/reset-password" | "/auth/verify" | "/booking" | "/booking/artist" | "/booking/customers" | "/calendar" | "/dashboard" | "/letter" | "/login" | "/login/forgot-password" | "/login/register" | "/login/reset-confirmed" | "/login/reset-password" | "/marketing" | "/marketing/eventsinfo" | "/production" | "/production/backline" | "/production/emailtech" | "/settimes" | "/settings" | "/wifi";
		RouteParams(): {
