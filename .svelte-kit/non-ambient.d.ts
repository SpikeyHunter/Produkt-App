...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/advancing" | "/advancing/gathered" | "/advancing/gathered/[event_param]" | "/api" | "/api/flight-lookup" | "/api/generate-advance-pdf" | "/api/google-calendar" | "/api/guests" | "/api/passport-ocr" | "/api/register" | "/api/update-event" | "/api/upload" | "/api/validate-registration-code" | "/api/validate-team-code" | "/auth" | "/auth/callback" | "/auth/forgot-password" | "/auth/reset-password" | "/auth/verify" | "/booking" | "/booking/artist" | "/booking/settimes" | "/calendar" | "/dashboard" | "/letter" | "/login" | "/login/forgot-password" | "/login/register" | "/login/reset-confirmed" | "/login/reset-password" | "/marketing" | "/marketing/eventsinfo" | "/production" | "/production/backline" | "/settings" | "/wifi";
		RouteParams(): {
		...
		Pathname(): "/" | "/advancing" | "/advancing/" | "/advancing/gathered" | "/advancing/gathered/" | `/advancing/gathered/${string}` & {} | `/advancing/gathered/${string}/` & {} | "/api" | "/api/" | "/api/flight-lookup" | "/api/flight-lookup/" | "/api/generate-advance-pdf" | "/api/generate-advance-pdf/" | "/api/google-calendar" | "/api/google-calendar/" | "/api/guests" | "/api/guests/" | "/api/passport-ocr" | "/api/passport-ocr/" | "/api/register" | "/api/register/" | "/api/update-event" | "/api/update-event/" | "/api/upload" | "/api/upload/" | "/api/validate-registration-code" | "/api/validate-registration-code/" | "/api/validate-team-code" | "/api/validate-team-code/" | "/auth" | "/auth/" | "/auth/callback" | "/auth/callback/" | "/auth/forgot-password" | "/auth/forgot-password/" | "/auth/reset-password" | "/auth/reset-password/" | "/auth/verify" | "/auth/verify/" | "/booking" | "/booking/" | "/booking/artist" | "/booking/artist/" | "/booking/settimes" | "/booking/settimes/" | "/calendar" | "/calendar/" | "/dashboard" | "/dashboard/" | "/letter" | "/letter/" | "/login" | "/login/" | "/login/forgot-password" | "/login/forgot-password/" | "/login/register" | "/login/register/" | "/login/reset-confirmed" | "/login/reset-confirmed/" | "/login/reset-password" | "/login/reset-password/" | "/marketing" | "/marketing/" | "/marketing/eventsinfo" | "/marketing/eventsinfo/" | "/production" | "/production/" | "/production/backline" | "/production/backline/" | "/settings" | "/settings/" | "/wifi" | "/wifi/";
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/.DS_Store" | "/favicon.svg" | "/images/.DS_Store" | "/images/NCG_LOGO2_BLANC.png" | "/images/ProduktXX_LOGO1.png" | "/images/ProduktXX_LOGO2.png" | "/images/ProduktXX_LOGO_lockup.png" | "/pdf/.DS_Store" | "/pdf/IMM5686E_Template_Empty.pdf" | "/pdf/Invitation Letter.pdf" | string & {};
	}
}