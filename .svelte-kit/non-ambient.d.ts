...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/advancing" | "/advancing/artistliaison" | "/advancing/gathered" | "/advancing/gathered/[event_param]" | "/advancing/hoteltracker" | "/advancing/localartists" | "/advancing/merchsettlement" | "/api" | "/api/apple" | "/api/booking" | "/api/booking/evenko" | "/api/booking/evenko/cancel" | "/api/booking/igloofest" | "/api/booking/igloofest/cancel" | "/api/booking/piknic" | "/api/booking/piknic/cancel" | "/api/bug-report" | "/api/calendar-confirm-email" | "/api/calendar-confirm-sms" | "/api/calendar-invite-mail" | "/api/calendar-invite-phone" | "/api/calendar-modify-email" | "/api/calendar-modify-sms" | "/api/calendar" | "/api/deezer" | "/api/deezer/search" | "/api/download-tech-rider" | "/api/flight-lookup" | "/api/generate-advance-pdf" | "/api/generate-bottle-details" | "/api/generate-liaison-pdf" | "/api/generate-merch-pdf" | "/api/generate-settimes-pdf" | "/api/google-calendar" | "/api/guests" | "/api/latest-commit" | "/api/passport-ocr" | "/api/register" | "/api/scrape-saq" | "/api/sync-drive-rider" | "/api/update-event" | "/api/upload" | "/api/validate-registration-code" | "/api/validate-team-code" | "/api/webhooks" | "/api/webhooks/sns-inbound" | "/auth" | "/auth/callback" | "/auth/forgot-password" | "/auth/reset-password" | "/auth/verify" | "/bazart" | "/booking" | "/booking/artistavailability" | "/booking/dailycount" | "/booking/talentpayments" | "/boxoffice" | "/calendar" | "/calendar/unsubscribe" | "/calendar/[id]" | "/calendar/[id]/[[tab]]" | "/contact-card" | "/dashboard" | "/letter" | "/login" | "/login/forgot-password" | "/login/register" | "/login/reset-confirmed" | "/login/reset-password" | "/marketing" | "/marketing/comparehub" | "/marketing/comptickets" | "/marketing/customers" | "/marketing/eventsinfo" | "/ncgapp" | "/ncgapp/controlcenter" | "/production" | "/production/backline" | "/production/emailtech" | "/production/showbudget" | "/production/techrider" | "/public" | "/public/invoice" | "/public/invoice/[token]" | "/schedules" | "/schedules/stagemanager" | "/schedules/tech" | "/settimes" | "/settings" | "/sultanshepard" | "/sultanshepard/djshow" | "/sultanshepard/djshow/[id]" | "/sultanshepard/tour" | "/wifi" | "/wifi/corpo" | "/wifi/ncg";
		RouteParams(): {
		...
		Pathname(): "/" | "/advancing/artistliaison" | "/advancing/gathered" | `/advancing/gathered/${string}` & {} | "/advancing/hoteltracker" | "/advancing/localartists" | "/advancing/merchsettlement" | "/api/apple" | "/api/booking/evenko" | "/api/booking/evenko/cancel" | "/api/booking/igloofest" | "/api/booking/igloofest/cancel" | "/api/booking/piknic" | "/api/booking/piknic/cancel" | "/api/bug-report" | "/api/calendar-confirm-email" | "/api/calendar-confirm-sms" | "/api/calendar-invite-mail" | "/api/calendar-invite-phone" | "/api/calendar-modify-email" | "/api/calendar-modify-sms" | "/api/calendar" | "/api/deezer/search" | "/api/download-tech-rider" | "/api/flight-lookup" | "/api/generate-advance-pdf" | "/api/generate-bottle-details" | "/api/generate-liaison-pdf" | "/api/generate-merch-pdf" | "/api/generate-settimes-pdf" | "/api/google-calendar" | "/api/guests" | "/api/latest-commit" | "/api/passport-ocr" | "/api/register" | "/api/scrape-saq" | "/api/sync-drive-rider" | "/api/upload" | "/api/validate-registration-code" | "/api/validate-team-code" | "/api/webhooks/sns-inbound" | "/auth/callback" | "/auth/forgot-password" | "/auth/reset-password" | "/auth/verify" | "/bazart" | "/booking/artistavailability" | "/booking/dailycount" | "/booking/talentpayments" | "/boxoffice" | "/calendar" | "/calendar/unsubscribe" | `/calendar/${string}${string}` & {} | "/contact-card" | "/dashboard" | "/letter" | "/login/forgot-password" | "/login/register" | "/login/reset-confirmed" | "/login/reset-password" | "/marketing/comparehub" | "/marketing/comptickets" | "/marketing/customers" | "/marketing/eventsinfo" | "/ncgapp/controlcenter" | "/production/backline" | "/production/emailtech" | "/production/showbudget" | "/production/techrider" | `/public/invoice/${string}` & {} | "/schedules/stagemanager" | "/schedules/tech" | "/settimes" | "/settings" | "/sultanshepard/djshow" | `/sultanshepard/djshow/${string}` & {} | "/sultanshepard/tour" | "/wifi/corpo" | "/wifi/ncg";
