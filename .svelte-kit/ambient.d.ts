...
declare module '$env/static/private' {
	...
	export const TIXR_GROUP_ID: string;
	export const TIXR_CPK: string;
	export const TIXR_SECRET_KEY: string;
	...
	export const GOOGLE_P_DRIVE_CLIENT_EMAIL: string;
	export const GOOGLE_P_DRIVE_PRIVATE_KEY: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TIXR_GROUP_ID: string;
		TIXR_CPK: string;
		TIXR_SECRET_KEY: string;
		TEAM_ADVANCE: string;
		TEAM_BOOKING: string;
		...
		GOOGLE_P_DRIVE_CLIENT_EMAIL: string;
		GOOGLE_P_DRIVE_PRIVATE_KEY: string;
